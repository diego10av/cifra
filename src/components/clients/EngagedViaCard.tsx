      ...
      <div id="engaged-via" className="bg-amber-50/30 border border-amber-200 rounded-lg px-4 py-3">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 text-2xs uppercase tracking-wide font-semibold text-amber-800">
            ...
            <div className="mt-1 text-2xs text-ink-muted italic leading-relaxed">
