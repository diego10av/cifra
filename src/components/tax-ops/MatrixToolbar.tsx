  ...
  return (
    ...
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <div className="ml-auto flex items-center gap-2">
        {/* Stint 64.V.2 — density toggle removed. Diego: "no sé
            exactamente para lo que es, ni para lo que sirve". The
            comfortable-vs-compact CSS rule (data-attribute on the
            wrapper) stays in TaxTypeMatrix so we can re-expose it
            via Settings later if there's real demand. */}
        <button
          type="button"
...
// Stint 64.V.2 — DensityToggle removed. The use-density hook + the
// data-attribute hook in TaxTypeMatrix stay in case we re-expose the
// preference later via Settings; nothing references this component
// from the toolbar anymore.
