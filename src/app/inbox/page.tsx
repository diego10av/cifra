...
// docs/PROTOCOLS.md, the legacy-home links, even the
// `g i` shortcut comment) still use the term "inbox". A 404 on
// /inbox is therefore a foreseeable user request — Diego or a
// reader of the docs types it expecting to land on the AED letters
// surface. Server-side redirect is the cheapest fix: one round-trip
// to /aed-letters, no broken bookmarks.
