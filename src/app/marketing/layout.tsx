...
export const metadata: Metadata = {
  title: 'cifra — operating system for private capital structures',
  description:
    'cifra is the operating system for private capital structures in Europe. Compliance, clients, entities, invoices — connected. Tax filings, sign-off cascade, audit trail in one workspace.',
