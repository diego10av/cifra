  ...
  if (!open) {
    return (
      <button
        ...
        className="mb-4 text-xs text-ink-faint hover:text-ink-soft cursor-pointer transition-colors flex items-center gap-1"
      >
  ...
  return (
    <div className="bg-amber-50/60 border border-amber-200 rounded-lg p-3 mb-4">
      <div className="flex items-center justify-between mb-1.5">
        <div className="text-xs uppercase tracking-wide font-semibold text-amber-700 flex items-center gap-1.5">
      ...
      <textarea
        ...
        className="w-full bg-transparent text-sm text-gray-800 resize-none"
      />
    </div>
  );
}
  ...
  return (
    <div className="bg-surface border border-border rounded-lg mb-4 overflow-hidden">
      <div className="px-4 py-3 border-b border-border bg-surface-alt flex items-center justify-between">
        <div>
          <h3 className="text-sm font-semibold text-ink">Filing &amp; payment</h3>
        ...
        <button
          onClick={onReopen}
          className="h-7 px-2.5 rounded border border-orange-300 text-xs font-medium text-orange-600 hover:bg-orange-50 transition-all duration-150 cursor-pointer"
      ...
      <div className="p-4 grid grid-cols-3 gap-4">
        ...
        {status === 'approved' ? (
          <div className="border border-border rounded-md p-3 col-span-2">
            <div className="flex items-center gap-2 mb-2">
              <StepDot active />
              <div className="text-sm font-semibold text-ink">Mark as filed</div>
            </div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="h-8 px-3 rounded bg-brand-500 text-white text-xs font-semibold hover:bg-brand-600 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer transition-all duration-150"
              >
                Mark as filed
              </button>
            </div>
        ...
        {status === 'paid' ? (
          ...
          <div className="border border-border rounded-md p-3 col-span-3">
            <div className="flex items-center gap-2 mb-2">
              <StepDot active />
              <div className="text-sm font-semibold text-ink">Mark as paid</div>
            </div>
            <div className="text-xs text-ink-muted mb-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="h-8 px-3 rounded bg-green-600 text-white text-xs font-semibold hover:bg-green-700 cursor-pointer transition-all duration-150"
              >
                Mark as paid
              </button>
            </div>
          ...
          <div className="bg-surface-alt border border-border rounded-md p-3">
            <div className="flex items-center justify-between gap-3">
              <div className="min-w-0">
                <div className="text-xs uppercase tracking-wide font-semibold text-ink-muted mb-0.5">
                  Proof of filing
                </div>
              ...
              <button
                ...
                className="shrink-0 h-7 px-2.5 rounded border border-border-strong text-xs font-medium text-ink-soft hover:bg-surface hover:border-gray-400 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer transition-all duration-150"
              >
...
function Step({
  ...
  return (
    <div className="border border-border rounded-md p-3 flex items-start gap-3">
      <div className={`shrink-0 w-6 h-6 rounded-full text-xs font-semibold flex items-center justify-center ${dotColor}`}>
        {state === 'done' ? '✓' : number}
      </div>
      <div className="min-w-0">
        <div className="text-sm font-semibold text-ink">{title}</div>
        <div className="text-xs text-ink-muted mt-0.5 truncate">{subtitle}</div>
      </div>
    </div>
  );
}
