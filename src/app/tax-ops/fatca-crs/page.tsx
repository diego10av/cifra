...
export default function FatcaCrsPage() {
  return (
    <div className="space-y-4 max-w-2xl">
      <Link href="/tax-ops" className="inline-flex items-center gap-1 text-[12px] text-ink-muted hover:text-ink">
      ...
      <div className="rounded-md border border-border bg-surface px-4 py-3 text-[12px] text-ink-soft">
        <strong className="text-ink">What this page will eventually show:</strong>
        <ul className="mt-1.5 list-disc list-inside space-y-0.5 text-[11.5px]">
